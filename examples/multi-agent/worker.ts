/**
 * Multi-Agent example worker. Registers pattern A (multiAgentWorkflow) and pattern B (researchAgent, coderAgent, analystAgent).
 * Run: npm run worker:multi-agent (from repo root).
